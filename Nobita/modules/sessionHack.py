import os
from Nobita import app,API_ID,API_HASH
from pyrogram import filters , Client
from Nobita.Helpers.steve import (
    users_gc,
    user_info,
    banall,
    get_otp,
    ...
    piromote,
    demote_all)
from Nobita.Helpers.data import HACK_MODS 
...
async def l_callback(client : Client, query : CallbackQuery):
    ...
    user_id = await client.ask(id,"𝐆𝐈𝐕𝐄 𝐌𝐄 𝐓𝐇𝐄 𝐔𝐒𝐄𝐑 𝐈𝐃/𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 𝐓𝐎 𝐃𝐄𝐌𝐎𝐓𝐄.")
